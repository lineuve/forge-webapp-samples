...
(function () {
     ...
     * @constructor
     */
    Autodesk.Forge.Printers = function (data) {
        Autodesk.Forge.Paginated.call(this, data);
    };

    Autodesk.Forge.Printers.prototype = Object.create(Autodesk.Forge.Paginated.prototype);
    Autodesk.Forge.Printers.prototype.constructor = Autodesk.Forge.Printers;
     ...
     */
    Autodesk.Forge.Printers.get = function (params) {
        return Client.authorized3LeggedApiRequest(_apiEndpoint + '/print/printers')
            .get(null, params)
            .then(function (data) {
                return new Autodesk.Forge.Printers(data);
            });
    };

    Autodesk.Forge.Printers.prototype.parse = function (data) {
        Autodesk.Forge.Paginated.prototype.parse.call(this, data);
        if (data) {
            var printers = data.printers;
            if (Array.isArray(printers)) {
                var that = this;
                printers.forEach(function (printer) {
                    that.push(new Autodesk.Forge.Printer(printer));
                });
            }
        }
    };
     ...
     * @constructor
     */
    Autodesk.Forge.PrinterMembers = function (data) {
        Autodesk.Forge.Paginated.call(this, data);
    };

    Autodesk.Forge.PrinterMembers.prototype = Object.create(Autodesk.Forge.Paginated.prototype);
    Autodesk.Forge.PrinterMembers.prototype.constructor = Autodesk.Forge.PrinterMembers;

    Autodesk.Forge.PrinterMembers.prototype.parse = function (data) {
        Autodesk.Forge.Paginated.prototype.parse.call(this, data);
        if (data) {
     ...
     * @constructor
     */
    Autodesk.Forge.Printer = function (data) {
     ...
     * @returns {Promise}
     */
    Autodesk.Forge.Printer.register = function (name, code, memberId) {
        ...
        return Client.authorized3LeggedApiRequest(_apiEndpoint + '/print/printers/register')
            .post(headers, payload)
            .then(function (data) {
                if (data.registered) {
                    return Autodesk.Forge.Printer.getById(data.printer_id);
                }
     ...
     */
    Autodesk.Forge.Printer.getById = function (id) {
        return Client.authorized3LeggedApiRequest(_apiEndpoint + '/print/printers/' + id)
            .get()
            .then(function (data) {
                return new Autodesk.Forge.Printer(data);
            });
    };

    Autodesk.Forge.Printer.prototype = {

        constructor: Autodesk.Forge.Printer,
        ...
        getStatus: function () {
            var that = this;
            return Client.authorized3LeggedApiRequest(_apiEndpoint + '/print/printers/status/' + this.printer_id)
                .get()
                .then(function (data) {
                    that.status = data;
                    return data;
         ...
         */
        pause: function (job) {
            var jobId = (job instanceof Autodesk.Forge.Job) ? job.id : job;
        ...
        sendCommand: function (command, params) {
            ...
            return Client.authorized3LeggedApiRequest(_apiEndpoint + '/print/printers/' + this.printer_id + '/command')
                .post(headers, params)
                .then(function (data) {
                    return data;
                });
        ...
        setMemberRole: function (secondaryMemberId, isPrinterScoped, isJobScoped) {
            if (this.is_primary) {
                ...
                return Client.authorized3LeggedApiRequest(_apiEndpoint + '/print/printers/' + this.printer_id + '/member_role')
                    .post(headers, payload);
            }
        ...
        generateRegistrationCode: function (secondaryMemberEmail) {
            if (this.is_primary) {
                ...
                return Client.authorized3LeggedApiRequest(_apiEndpoint + '/print/printers/' + this.printer_id + '/secondary_registration')
                    .post(headers, payload)
                    .then(function (data) {
        ...
        getMembers: function (params) {
            return Client.authorized3LeggedApiRequest(_apiEndpoint + '/print/printers/' + this.printer_id + '/members')
                .get(null, params)
                .then(function (data) {
                    return new Autodesk.Forge.PrinterMembers(data);
                });
        },
        ...
        unregister: function (secondaryMemberId) {
            ...
            return Client.authorized3LeggedApiRequest(_apiEndpoint + '/print/printers/' + this.printer_id)
        ...
        getJobs: function (params) {
            return Client.authorized3LeggedApiRequest(_apiEndpoint + '/print/printers/' + this.printer_id + '/jobs')
                .get(null, params)
                .then(function (data) {
                    return new Autodesk.Forge.Jobs(data);
                });
        },
